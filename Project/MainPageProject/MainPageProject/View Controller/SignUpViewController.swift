...
class SignUpViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        confirmPasswordText.leftView = UIImageView(image: #imageLiteral(resourceName: "Password"))
        confirmPasswordText.leftViewMode = .always
        confirmPasswordText.configureAttributedString(string: "패스워드를 다시 입력하세요", range: NSRange(location: 0, length: 4), stringColor: UIColor.red.withAlphaComponent(0.5))
