...
class AccountViewController: UIViewController {
  ...
  func autoContentView() {
    ...
    self.backBtn.topAnchor.constraint(equalTo: self.view.topAnchor).isActive = true
    self.backBtn.leftAnchor.constraint(equalTo: self.view.leftAnchor).isActive = true
    //self.backBtn.frame.size.width =
  }
